---
title: Python 3.11.0a3 is available
publishDate: '2021-12-08'
updatedDate: '2021-12-09'
author: Pablo Galindo
description: 'You can tell that we are slowly getting closer to the first beta as the number of release blockers that we need to fix on every release starts to increase !:...'
tags: []
published: true
legacyUrl: /2021/12/python-3110a3-is-available.html
---

You can tell that we are slowly getting closer to the first beta as the number of release blockers that we need to fix on every release starts to increase ![:sweat_smile:](./image-1.png) But we did it!

[https://www.python.org/downloads/release/python-3110a1/](https://www.python.org/downloads/release/python-3110a3/)
