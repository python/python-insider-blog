---
title: Python 3.11.0b2 is now available
publishDate: '2022-05-31'
updatedDate: '2022-05-31'
author: Pablo Galindo
description: 'Does anyone want bug fixes? Because we have 164 new commits fixing different things, from code to documentation. If you have reported some issue after 3.11.0...'
tags: []
published: true
legacyUrl: /2022/05/python-3110b2-is-now-available.html
---

Does anyone want bug fixes? Because we have 164 new commits fixing different things, from code to documentation. If you have reported some issue after 3.11.0b1, you should check if is fixed and if not, make sure you tell us so we can take a look ![:eyes:](./image-1.png) We still have two more betas to go so help us to make sure we don’t miss anything so everything is ready for the final release ![:rocket:](./image-2.png)

[https://www.python.org/downloads/release/python-3110b2/](https://www.python.org/downloads/release/python-3110b2/)
