---
title: Python 3.13.0 release candidate 1 released
publishDate: '2024-08-01'
updatedDate: '2024-08-01'
author: Thomas Wouters
description: 'I''m pleased to announce the release of Python 3.13 release candidate 1. https://www.python.org/downloads/release/python-3130rc1/ This is the first release ca...'
tags: []
published: true
legacyUrl: /2024/08/python-3130-release-candidate-1-released.html
---

I'm pleased to announce the release of Python 3.13 **release candidate 1**. [https://www.python.org/downloads/release/python-3130rc1/](https://www.python.org/downloads/release/python-3130rc1/)
...
For more details on the changes to Python 3.13, see [What’s new in Python 3.13](https://docs.python.org/3.13/whatsnew/3.13.html). The next pre-release of Python 3.13 will be 3.13.0rc2, **the final release candidate**, currently scheduled for 2024-09-03.
