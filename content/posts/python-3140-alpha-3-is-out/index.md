...
tags:
  - releases
published: true
legacyUrl: /2024/12/python-3140-alpha-3-is-out.html
---

O Alpha 3, O Alpha 3, how lovely are your branches!

[https://www.python.org/downloads/release/python-3140a3/](https://www.python.org/downloads/release/python-3140a3/)
...
According to the Oxford English Dictionary, the earliest mention of Christmas mince pies is by Thomas Dekker, writing in the aftermath of the [1603 London plague](https://en.wikipedia.org/wiki/1603_London_plague), in [*Newes from Graues-end: Sent to Nobody*](https://archive.org/details/bim_early-english-books-1475-1640_newes-from-graues-end-s_gravesend_1604/page/n10/mode/1up?q=mince+pyes) (1604):
