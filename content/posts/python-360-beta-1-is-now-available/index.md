---
title: 'Python 3.6.0 beta 1 is now available!'
publishDate: '2016-09-13'
updatedDate: '2016-09-13'
author: Ned Deily
description: 'Python 3.6.0b1 is the first of four planned beta releases of Python 3.6, the next major   release of Python, and marks the end of the feature development pha...'
tags: []
published: true
legacyUrl: /2016/09/python-360-beta-1-is-now-available.html
---
...
for 3.6. Among the major new features in Python 3.6 are: \* PEP 468 - Preserving the order of \*\*kwargs in a function  
...
production environments The next planned release of Python 3.6 will be 3.6.0b2, currently  
