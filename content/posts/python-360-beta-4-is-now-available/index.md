---
title: Python 3.6.0 beta 4 is now available
publishDate: '2016-11-22'
updatedDate: '2016-11-22'
author: Ned Deily
description: 'Python 3.6.0b4 is the last planned beta release of Python 3.6, the next major   release of Python. Among the major new features in Python 3.6 are: \ PEP 468 ...'
tags: []
published: true
legacyUrl: /2016/11/python-360-beta-4-is-now-available.html
---

Python 3.6.0b4 is the last planned beta release of Python 3.6, the next major  
release of Python. Among the major new features in Python 3.6 are: \* PEP 468 - Preserving the order of \*\*kwargs in a function  
...
report issues found to [bugs.python.org](http://bugs.python.org/) as soon as possible. While the  
...
production environments The next pre-release of Python 3.6 will be 3.6.0rc1, the release candidate,  
...
can be found here: [https://www.python.org/dev/peps/pep-0494/](https://www.python.org/dev/peps/pep-0494/)
